...
public class RemoveFromCommand extends AuthCommand {
    private static final int GROUP_NAME_TOKEN_ID = 1;
    private static final int URL_TOKEN_ID = 2;

    public RemoveFromCommand(SocketChannel sc, String... args) {
        super(sc, CommandType.REMOVE_FROM, args);
    }
    ...
    public String execute() {
        ...
        return Dispatcher.bookmarkManager().removeFrom(groupName, url, caller).response();
    }
}
